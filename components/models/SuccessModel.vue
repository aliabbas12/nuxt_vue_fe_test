...
const isOpenTranslationWithNoIssueModel = computed({
  get: () => modelStore.getSuccessModelState,
  set: (value) => {
    modelStore.setSuccessModelState(value);
  },
});
